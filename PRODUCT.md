...
## Product Purpose
Ryft renders its own native multi-display top bar and offers one place to customize appearance, modules, global controls, named bar configurations, themes, and wallpapers. Success means a user can install the app, choose or build a bar visually, use its keyboard-driven wallpaper carousel, and keep the setup working after relaunch without installing SketchyBar or running a web service.
