...
6. Open **Tiling** to install and enable the official notarized OmniWM engine. Ryft selects OmniWM’s Hyprland-style Dwindle layout so newly opened windows automatically split, resize, and move into place, while leaving OmniWM hotkeys off to preserve Ryft’s desktop shortcuts.
